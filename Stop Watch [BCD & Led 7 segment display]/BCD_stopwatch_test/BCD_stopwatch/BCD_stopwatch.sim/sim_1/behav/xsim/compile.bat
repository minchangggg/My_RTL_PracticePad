...
REM
REM Generated by Vivado on Sun Sep 21 23:16:59 +0700 2025
...
echo "xvlog --incr --relax -prj tb_bcd_stopwatch_vlog.prj"
call xvlog  --incr --relax -prj tb_bcd_stopwatch_vlog.prj -log xvlog.log
